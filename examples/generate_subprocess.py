"""
examples/generate_subprocess.py

Reference generator: calls any CLI tool, captures stdout as output,
and writes outputs to evals/outputs/ for fieldtest to score.

Usage:
  python examples/generate_subprocess.py [set_name]
